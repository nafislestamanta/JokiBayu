<section class="hero-area">
    <div class="hero-post-slides owl-carousel">
        ...
        <div class="single-hero-post bg-overlay">
            <!-- Post Image -->
            <div class="slide-img bg-img" style="background-image: url(assets_user/img/bg-img/onion-bg1.jpg);"></div>
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        ...
                        <div class="hero-slides-content text-center">
                            <h2>Sistem Pakar Diagnosis Hama dan Penyakit pada Bawang Merah </h2>
